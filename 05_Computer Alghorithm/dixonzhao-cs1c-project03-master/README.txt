stacks
        ...
        Navigator
            - Use to simulate control of two stack list and one current list
                ...
                -Setter for all three method
                -go forward() move the current to forward String(if have)
                -go backward() move the current to backward String(if have)
        BroserNavigation
            -main class
                -provide search of all links
