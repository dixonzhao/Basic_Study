...
public class FolderLinkedList
{
	 ...
	 */
	public void addFirstNode(Folder newDirectory)
	{
		...
		if (this.isEmpty())
		{
			FolderNode current = new FolderNode(newDirectory);
			head = current;
			this.length++;
		}
	 ...
	 * @param name		A new data item to be added to our list.
	 */
	public void addInFront(Folder newDirectory) 
	{	
	...
	public String toString()
	{
		...
		while(walker != null)
		{
			// When concatenating a String object with a FolderNode object,
